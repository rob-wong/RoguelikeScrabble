package com.cypherose

import androidx.test.espresso.IdlingRegistry
import androidx.test.ext.junit.rules.ActivityScenarioRule
import com.cypherose.app.MainActivity
import com.cypherose.app.util.dispatcher.DispatcherModule
import com.cypherose.business.network.UserStorage
import com.cypherose.testutil.TestEnvironment
...
class InstrumentedTests {
    ...
    fun verifyUserCreatedWithEmptyStorage() {
        ...
        activityRule.scenario.onActivity { activity ->
            ...
            Assert.assertEquals(0, user.runesCount)
        }
    }
}
