...
import com.cypherose.features.game.ui.animation.animateDiscardsShake
import com.cypherose.ui.theme.common
import kotlinx.coroutines.delay
import kotlin.math.roundToInt

@Composable
internal fun PerfectionismResultContent(
	oldMaxDiscards: Int,
	newMaxDiscards: Int,
	...
	Box(
		...
		Box(
			...
			Column(
				...
				OutlinedText(
					text = if (showNewValue) newMaxDiscards.toString() else oldMaxDiscards.toString(),
