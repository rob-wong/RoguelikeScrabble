...
import com.example.gymapprefactor.business.gameplayLoop.domain.mappers.DrawHandMapper.Param
import com.example.gymapprefactor.business.gameplayLoop.domain.mappers.DrawHandMapper.Output
...
class DrawHandMapperImpl : DrawHandMapper {
	...
	companion object {
		 ...
		 */
		@JvmStatic
		var DEBUG_HAND_STRING: String? = "TRIPLE"
	}
